...
| **3º Himalaia (2026)** | 26/08/2026 02:52 UTC | Ciclo 25 (Pico Máximo) | **Flare M7.0** (AR 3792)<br>25/08/2026 10:02 UTC | $\mathbf{7.0 \times 10^{-5}\text{ W/m}^2}$ | **16h e 50min** | $Kp = 3.7$<br>$Dst = -28\text{ nT}$ | $\mathbf{4.57\text{ pA/m}^2}$ | Absorção D-RAP de 28.5 dB; 14 magnetômetros trans-himalaios registraram salto de VI para 356.4 kV. |
